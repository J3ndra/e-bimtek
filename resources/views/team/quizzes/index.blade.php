...
<div class="container page__container page-section">
    ...
    <div class="page-separator">
        ...
        <a class="btn btn-primary float-right ml-auto" href="{{ route('team.quizzes.create') }}"><i
        ...
        <div class="card-group-row__col col-md-6">
            <div class="card card-group-row__card card-sm">
                <div class="card-body d-flex align-items-center">
                    <a href="{{ route('team.quizzes.edit', $quiz->id) }}"
                ...
                <div class="card-footer">
                    <div class="d-flex align-items-center">
                        <div class="flex mr-2">
                            <a href="{{ route('team.quizzes.edit', $quiz->id) }}" class="btn btn-light btn-sm">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="{{ route('team.quizzes.edit', $quiz->id) }}" class="dropdown-item">Edit</a>
                                <div class="dropdown-divider"></div>
                                <form method="POST" action="{{ route('team.quizzes.destroy', $quiz->id) }}"
