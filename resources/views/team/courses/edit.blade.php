...
<x-breadcumb title="Page" sub="Edit Bimtek: {{ $course->title }}" />
    <div class="container page__container page-section">
        ...
        <form method="POST" action="{{ route('team.courses.update', $course->id) }}" id="form-page" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            ...
            <div class="row">
                    ...
                    <div class="accordion js-accordion accordion--boxed mb-24pt" id="parent">
                        ...
                        <div class="accordion__menu collapse" id="course-toc-{{ $lesson->id }}">
                            ...
                            <div class="accordion__menu-link">
                                ...
                                <a href="{{ route('team.sublessons.edit', [$course->id, $lesson->id, $sub->id]) }}" class="btn btn-sm btn-warning text-white ml-2"><i class="material-icons" style="font-size: 12px;">edit</i></a>
                                <a href="{{ route('team.sublessons.destroy', [$course->id, $lesson->id, $sub->id]) }}" class="btn btn-sm btn-danger text-white ml-2"><i class="material-icons" style="font-size: 12px;">delete</i></a>
                            </div>
                            @endforeach
                            <div class="m-2">
                                <a href="{{ route('team.lessons.edit', [$course->id, $lesson->id]) }}" class="btn btn-outline-warning btn-sm ml-2">
                                    <i class="material-icons">edit</i> Edit
                                </a>
                                <a href="{{ route('team.lessons.destroy', [$course->id, $lesson->id]) }}" class="btn btn-sm btn-outline-danger ml-2"><i class="material-icons">delete</i> Hapus</a>
                                <a href="{{ route('team.sublessons.create', [$course->id, $lesson->id]) }}" class="btn btn-outline-primary btn-sm ml-2">
                ...
                <a href="{{ route('team.lessons.create', $course->id) }}" class="btn btn-outline-secondary mb-24pt mb-sm-0">Tambah Pembelajaran</a>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="date-course" type="text" name="date_course"
