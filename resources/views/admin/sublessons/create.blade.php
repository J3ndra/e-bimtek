...
@section('title', 'Tambah Sub Pembelajaran')
@section('styles')
<!-- Quill Theme -->
...
@endsection
@section('content')
<x-breadcumb title="Page" sub="Tambah Sub Pembelajaran" />
<div class="container page__container page-section">
    <form method="POST" action="{{ route('admin.sublessons.store', [$course->id, $lesson->id]) }}"
            ...
            <div class="col-md-8">
                ...
                <div class="form-group mb-24pt">
                    <input type="text" name="title"
                        ...
                        value="{{ old('title') }}" placeholder="Judul Sub Pembelajaran">
                    @error('title')
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="type" id="type" class="form-control">
                                ...
                                <option value="video" {{ old('video') ? 'selected' : '' }}>Video</option>
                                <option value="pdf" {{ old('pdf') ? 'selected' : '' }}>PDF</option>
                            </select>
                        </div>
                        <div class="form-group" id="video" style="{{ old('video') ? '' : 'display: none' }};">
                        ...
                        <div class="form-group" id="pdf" style="{{ old('pdf') ? '' : 'display: none' }};">
