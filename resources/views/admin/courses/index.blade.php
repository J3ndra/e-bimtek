...
<div class="container page__container page-section">
    ...
    <div class="page-separator">
        ...
        <a class="btn btn-primary float-right ml-auto" href="{{ route('admin.courses.create') }}"><i
                class="fa fa-plus mr-2"></i> Bimtek Baru</a>
    </div>
        ...
        @foreach($courses as $course)
            <div class="col-sm-6 col-md-4 col-xl-3">
                ...
                <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary js-overlay mdk-reveal js-mdk-reveal "
                    ...
                    <a href="{{ route('admin.courses.edit', $course->id) }}" class="js-image"
                        data-position="left">
                        <img src="{{ Storage::url($course->thumbnail) }}" alt="{{ $course->title }}" width="430"
                            height="168">
                            ...
                            <div class="d-flex">
                                <div class="flex">
                                    <a class="card-title mb-4pt"
                                        href="{{ route('admin.courses.edit', $course->id) }}">{{ $course->title }}</a>
                                </div>
                                <a href="{{ route('admin.courses.edit', $course->id) }}l"
                    ...
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <div class="d-flex align-items-center mb-4pt">
                                <span class="material-icons icon-16pt text-50 mr-4pt">supervised_user_circle</span>
                                <p class="flex text-50 lh-1 mb-0"><small>Team:
                                        {{ optional($course->admin)->name ?? '-' }}</small>
                                </p>
                            </div>
                            <div class="d-flex align-items-center mb-4pt">
                            ...
                            <div class="d-flex align-items-center mb-4pt">
                                ...
                                <p class="flex text-50 lh-1 mb-0"><small>Penghasilan:
                                        Rp{{ number_format($course->income) }}</small></p>
                            </div>
                        </div>
