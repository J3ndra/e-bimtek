...
@section('title', 'Tambah Pembelajaran: ' . $course->title)
@section('styles')
<!-- Quill Theme -->
...
@endsection
@section('content')
<x-breadcumb title="Bimtek" sub="Tambah Pembelajaran: {{ $course->title }}" />
<div class="container page__container page-section">
    <form method="POST" action="{{ route('admin.lessons.store', $course->id) }}" enctype="multipart/form-data"
        id="form-page">
        @csrf
            ...
            <div class="col-md-8">
                ...
                <div class="form-group mb-24pt">
                    <input type="text" name="title"
                        ...
                        value="{{ old('title') }}" placeholder="Judul Pembelajaran">
                    @error('title')
