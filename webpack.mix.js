...
mix
  ...
  .sass('resources/sass/dark.scss', 'public/css', sassOptions)
  .sass('resources/sass/preloader.scss', 'public/css', sassOptions)
  .sass('resources/sass/vendor/bootstrap-datepicker.scss', 'public/css', sassOptions)
  .sass('resources/sass/vendor/bootstrap-timepicker.scss', 'public/css', sassOptions)
  .sass('resources/sass/vendor/bootstrap-touchspin.scss', 'public/css', sassOptions)
  .sass('resources/sass/vendor/dropzone.scss', 'public/css', sassOptions)
  .sass('resources/sass/vendor/fancytree.scss', 'public/css', sassOptions)
  .sass('resources/sass/vendor/flatpickr-airbnb.scss', 'public/css', sassOptions)
  .sass('resources/sass/vendor/flatpickr.scss', 'public/css', sassOptions)
  .sass('resources/sass/vendor/fontawesome.scss', 'public/css', sassOptions)
  .sass('resources/sass/vendor/fullcalendar.scss', 'public/css', sassOptions)
  .sass('resources/sass/vendor/ion-rangeslider.scss', 'public/css', sassOptions)
  .sass('resources/sass/vendor/jvectormap.scss', 'public/css', sassOptions)
  .sass('resources/sass/vendor/material-icons.scss', 'public/css', sassOptions)
  .sass('resources/sass/vendor/nestable.scss', 'public/css', sassOptions)
  .sass('resources/sass/vendor/quill.scss', 'public/css', sassOptions)
  .sass('resources/sass/vendor/select2.scss', 'public/css', sassOptions)
  .sass('resources/sass/vendor/sweetalert.scss', 'public/css', sassOptions)
  .sass('resources/sass/vendor/toastr.scss', 'public/css', sassOptions)
